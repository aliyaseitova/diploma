...
def run_lp_optimization(
    ...
    if co2_budget_mt is not None:
        prob += pulp.lpSum(gen[t] * TECHNOLOGIES[t]["co2_factor_t_mwh"] for t in techs) <= co2_budget_mt, "CO2"
